...
def scrape_data(url):
  ...
  try:
    ...
    if element:
      ...
      element_2 = details.find(class_="details")
      print(element_2)
    objectData['reviews'] = discription if discription else ''
...
for page in range(491):
  ...
  for td in tbody.find_all(class_="views-field views-field-letter"):
    ...
    scrape_data("https://www.fca.org.uk/news/warnings/meta-fx-meta-forex-markets-ltd")
...
excel_file_path = 'testingData.xlsx'
